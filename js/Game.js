class Game {
  ...
  //Função para barra do tanque de gasolina
  ...
  //Função que exibe a barra de vida
  showLife() {
    push();
  ...
  showLeaderboard() {
    ...
    //caso o jogador 1 chegue primeiro
    if(players[0].rank == 0 && players[1].rank == 0 || players[0].rank == 1) {
      leader1 = players[0].rank + "&emsp;" + players[0].name + "&emsp;" + players[0].score;
      leader2 = players[1].rank + "&emsp;" + players[1].name + "&emsp;" + players[1].score;
    }
    
    //caso o jogador 2 chegue primeiro
    if(players[1].rank == 1) {
  ...
  //Função pop-up na tela com Ranking na chegada
  showRank() {
    swal({
      title: `Incrível!${"\n"}Rank${"\n"}${player.rank}`,
  ...
  //Função pop-up na tela com Fim do jogo
  gameOver() {
    swal({
      title: `Fim de Jogo`,
